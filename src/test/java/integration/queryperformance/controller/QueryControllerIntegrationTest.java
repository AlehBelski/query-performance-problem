package integration.queryperformance.controller;
...
public class QueryControllerIntegrationTest {
    ...
    @Test
    public void shouldProcessWithoutError() throws Exception { //fixme run embedded db and override properties
        ...
        assertEquals(response.size(), 2); //fixme change when embedded db will be introduced
